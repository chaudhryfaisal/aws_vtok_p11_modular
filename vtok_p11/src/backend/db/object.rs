...
use vtok_p11_trait::{self as crypto, CertCategory};
use crate::pkcs11;
...
impl Object {
    ...
    pub fn new_x509_cert(info: CertInfo) -> Self {
        ...
        let categ = match info.categ {
            CertCategory::Unverified => pkcs11::CK_CERTIFICATE_CATEGORY_UNSPECIFIED,
            CertCategory::Token => pkcs11::CK_CERTIFICATE_CATEGORY_TOKEN_USER,
            CertCategory::Authority => pkcs11::CK_CERTIFICATE_CATEGORY_AUTHORITY,
            CertCategory::Other => pkcs11::CK_CERTIFICATE_CATEGORY_OTHER_ENTITY,
        };
        attrs.insert(
