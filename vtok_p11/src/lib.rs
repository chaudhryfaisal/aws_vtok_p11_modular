...
mod defs {
    ...
    use vtok_p11_trait::{MechDigest, Mechanism};
...
mod data {
    ...
    use super::backend::device_trait::DeviceTrait;
    use super::defs;
    use super::pkcs11::*;
    ...
    lazy_static! {
        pub static ref DEVICE: Mutex<Option<Box<dyn DeviceTrait + Send + Sync>>> = Mutex::new(None);
    }
}
